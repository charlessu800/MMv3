...
1. Navigate to the extension  
   <img style="width:200; height:auto;"  src="imgs/sanity/extension_finder.png"/>

3. Download the extension finder  
   <img style="width:200; height:auto;" src="imgs/sanity/serial_monitor_install.png"/>

5. Start monitoring  
   <img style="width:200; height:auto;" src="imgs/sanity/startMonitoring.png"/>

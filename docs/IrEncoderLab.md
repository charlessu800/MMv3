...
Originally, this entire lab consisted of two labs total: IR sensing and Encoders. Nowadays we've merged them into two for your enjoyment and hopefully ease-of-learning. We're gonna start with IR sensing and then move to encoders. 
